...
class PasswordGeneratorGUI:
    def __init__(self, master):
        ...
        # Apply dark theme
        master.configure(bg="#2b2b2b")  # Set background color
        master.option_add("*foreground", "white")  # Set foreground (text) color
        ...
        self.length_label = tk.Label(master, text="Password length:", bg="#2b2b2b")
        self.length_label.grid(row=0, column=0, sticky="W")
        self.length_entry = tk.Entry(master, width=max_length, bg="#424242", fg="white")
        ...
        self.generate_button = tk.Button(master, text="Generate", command=self.generate_password, bg="#757575", fg="white")
        self.generate_button.grid(row=1, column=0, columnspan=2, pady=5)

        # Create and place output label
        self.password_label = tk.Label(master, text="", bg="#2b2b2b")
        self.password_label.grid(row=2, column=0, columnspan=2, pady=5)

        # Create and place copy button
        self.copy_button = tk.Button(master, text="Copy to Clipboard", command=self.copy_password, bg="#757575", fg="white")
